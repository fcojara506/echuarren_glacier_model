...
##                            glacier                           -
##---------------------------------------------------------------
"Elev_Adj_glacier_surf" = c(1,1,1),
"firnstorage" = c(0,0.5,0.5),
"firn_Albedo" = c(0,0.4,0.4), # Maria 0.75 white
"firn_dens_init" = c(450,450,450),
"firn_h_init" = c(0,0,0),
"inhibit_firnmelt" = c(0,0,0),
"inhibit_icenmelt" = c(0,0,0),
"iceLag" = c(0,0,0),
"icestorage" = c(0,0.1,0.1), #Maria 2.2, 3.9 default 0.1
"ice_Albedo" = c(0,0.3,0.3),
