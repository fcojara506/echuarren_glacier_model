...
setwd("C:/Users/maria/Documents/PEGA/PROYECTOS/ECHAURREN/BALANCE DE MASA/")
source("mass_balance.R")
basin_df = read.csv2(file = "HRU_basin_properties.csv")[,c("HRU","area_km2")]


date_range = c(as.Date("2016-04-01"),
               as.Date("2022-11-01"))
df_filename = "balance_masa.txt"
...
write.csv(x = df2,file = paste0("balance_de_masa_total",tag,".csv"),row.names = F)
